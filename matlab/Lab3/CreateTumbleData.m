...
% Calculate the dynamic range for the accelerometer based on the gravitational field
accel_dynamic_range_x = norm(Ge);
accel_dynamic_range_y = norm(Ge);
accel_dynamic_range_z = norm(Ge);

% Display dynamic ranges for accelerometer
fprintf('Accelerometer dynamic range:\n');
fprintf('X axis: %d\n', accel_dynamic_range_x);
fprintf('Y axis: %d\n', accel_dynamic_range_y);
fprintf('Z axis: %d\n', accel_dynamic_range_z);

% Calculate the dynamic range for the magnetometer based on the magnetic field
mag_dynamic_range_x = norm(He);
mag_dynamic_range_y = norm(He);
mag_dynamic_range_z = norm(He);

% Display dynamic ranges for magnetometer
fprintf('\nMagnetometer dynamic range (in µT):\n');
fprintf('X axis: %.6f µT\n', mag_dynamic_range_x);
fprintf('Y axis: %.6f µT\n', mag_dynamic_range_y);
fprintf('Z axis: %.6f µT\n', mag_dynamic_range_z);
