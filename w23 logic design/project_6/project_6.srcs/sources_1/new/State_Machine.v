...
//    assign D[0] = (Q[0] & ~go) | (Q[5] & go) | (Q[4] & T1);
    assign D[0] = (Q[0] & ~go) | (Q[3] &  T3) | (Q[4] & T1);
    
    //ship fall
    assign D[1] = (go & Q[0]) | (Q[1] & ~collisionShipWithFloor) ;
...
//    assign resetTimer = (Q[1] & collisionShipWithFloor) | (Q[2] & T1) | (Q[3] & T3) | (Q[3] & collisionPinkSlugWithPlayer);
    assign resetTimer = (Q[1] & collisionShipWithFloor) | (Q[2] & T1);
    assign scoreUp = Q[4] & T1;
    assign shipReset = (go & Q[0]);
