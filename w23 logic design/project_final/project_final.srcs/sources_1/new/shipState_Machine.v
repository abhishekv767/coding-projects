...
module shipSMachine_Logic(
    ...
    //ship1 come down
    assign D[1] = (go & Q[0]) | (Q[1] & ~T1)  | (Q[5] & T1) ;
    
    //ship2
    assign D[2] = (Q[1] & T1) | (Q[2] & ~T1);
    
    //ship3
    assign D[3] = (Q[2] & T1) | (Q[3] & ~T1);
    
    //ship4
    assign D[4] = (Q[3] & T1) | (Q[4] & ~T1);
    
    //ship5
    assign D[5] = (Q[4] & T1) | (Q[5] & ~T1);
    
    assign resetTimer = (go & Q[0]) | (Q[1] & T1) | (Q[2] & T1) | (Q[3] & T1) | (Q[4] & T1) | (Q[5] & T1);
