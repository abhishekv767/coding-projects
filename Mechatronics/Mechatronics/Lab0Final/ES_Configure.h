...
#define EVENT_CHECK_LIST CheckBattery, CheckLightLevel, CheckBumpEvent
...
#define TIMER0_RESP_FUNC PostTemplateHSM
...
#define FSM_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define fiveSecondTimer 1 
#define darkAdjust 2
